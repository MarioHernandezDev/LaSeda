...
import { defineComponent, ref, resolveDirective, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, toDisplayString, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrGetDirectiveProps, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderClass, ssrRenderComponent } from 'vue/server-renderer';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    ctaTitulo: { default: "¿Prefieres que hablemos directamente?" },
    ctaDescripcion: { default: "Estamos aquí para escucharte de forma activa. La primera orientación telefónica es completamente gratuita y sin compromiso alguno." },
    ctaLabel: { default: "Reservar orientación" },
    cierreSecundario: { default: "Contactar por WhatsApp" },
    cierreSecundarioUrl: { default: "https://wa.me/34679571977?text=Hola,%20me%20gustar%C3%ADa%20recibir%20informaci%C3%B3n%20sobre%20la%20orientaci%C3%B3n%20gratuita." },
    cierreLabel: {},
    cierreDescripcion: {}
  },
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.faqs.length > 0) {
        ...
        ssrRenderList(__props.faqs, (faq, i) => {
          _push(`<div class="py-2"><button class="w-full flex items-center justify-between py-6 text-left group"${ssrRenderAttr("aria-expanded", unref(faqAbierta) === i)}><span class="text-base md:text-lg font-serif italic text-[#27252B] tracking-tight group-hover:text-[#71B1A5] transition-colors duration-300">${ssrInterpolate(faq.pregunta)}</span><span class="relative w-5 h-5 shrink-0 ml-4" aria-hidden="true"><span class="${ssrRenderClass([unref(faqAbierta) === i ? "rotate-90 opacity-0" : "rotate-0", "absolute inset-0 w-px h-4 bg-[#71B1A5] mx-auto transition-transform duration-500 ease-out"])}"></span><span class="absolute inset-0 h-px w-4 bg-[#71B1A5] my-auto"></span></span></button><div class="${ssrRenderClass([unref(faqAbierta) === i ? "grid-rows-[1fr] opacity-100 pb-6" : "grid-rows-[0fr] opacity-0 pointer-events-none", "grid transition-all duration-500 ease-in-out text-[#27252B]/60 font-light leading-relaxed text-sm md:text-base"])}"><div class="overflow-hidden"><p class="pr-4">${ssrInterpolate(faq.respuesta)}</p></div></div></div>`);
        });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/therapy/TherapyFAQ.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_6 = Object.assign(_sfc_main, { __name: "TherapyFAQ" });

export { __nuxt_component_6 as _ };
//# sourceMappingURL=TherapyFAQ-CT93uQmn.mjs.map
