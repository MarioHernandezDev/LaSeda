...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full text-[#27252B] font-sans pt-12 md:pt-16 pb-24 lg:pb-32 space-y-24 lg:space-y-36 bg-[#FDFBF9]" }, _attrs))} data-v-2d1709b6><section${ssrRenderAttrs(mergeProps({
        id: "sobre-el-taller",
        class: "flex justify-center border-b border-[#27252B]/5 pb-24"
      }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-2d1709b6><div class="px-6 sm:px-16 md:px-24 py-8 lg:py-24 w-full max-w-4xl flex flex-col justify-center items-center text-center" data-v-2d1709b6><div class="space-y-6 w-full" data-v-2d1709b6><div class="flex items-center justify-center gap-3" data-v-2d1709b6><span class="w-6 h-px bg-[#71B1A5]" aria-hidden="true" data-v-2d1709b6></span><p class="text-xs font-bold tracking-[0.3em] uppercase text-[#71B1A5]" data-v-2d1709b6>${ssrInterpolate(__props.introduccionLabel)}</p></div><h2 class="font-serif italic text-3xl md:text-4xl lg:text-[40px] text-[#27252B] font-normal leading-tight tracking-tight" data-v-2d1709b6>${ssrInterpolate(__props.introduccionTitulo)}<br data-v-2d1709b6><span class="text-[#27252B]/50 not-italic font-sans font-light text-2xl md:text-3xl block mt-1" data-v-2d1709b6>${ssrInterpolate(__props.introduccionTituloSecundario)}</span></h2><div class="space-y-6 text-stone-600/90 text-sm md:text-base leading-relaxed md:leading-loose font-light tracking-wide pt-2" data-v-2d1709b6><p data-v-2d1709b6>${ssrInterpolate(__props.descripcion)}</p><p data-v-2d1709b6>${ssrInterpolate(__props.descripcion2)}</p>`);
      if (__props.descripcion3) {
        _push(`<p data-v-2d1709b6>${ssrInterpolate(__props.descripcion3)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></div></section>`);
      if (__props.facilitadora) {
        _push(`<section${ssrRenderAttrs(mergeProps({ class: "grid grid-cols-1 lg:grid-cols-2 items-center min-h-[50vh] lg:min-h-[650px] gap-8 lg:gap-0" }, ssrGetDirectiveProps(_ctx, _directive_reveal)))} data-v-2d1709b6><div class="px-6 sm:px-16 md:px-24 py-8 lg:py-24 w-full flex flex-col justify-center items-end lg:max-w-[90%] xl:max-w-[85%] justify-self-end order-2 lg:order-1" data-v-2d1709b6><div class="space-y-6 w-full" data-v-2d1709b6><div class="flex items-center gap-3" data-v-2d1709b6><span class="w-6 h-px bg-[#71B1A5]" aria-hidden="true" data-v-2d1709b6></span><p class="text-xs font-bold tracking-[0.3em] uppercase text-[#71B1A5]" data-v-2d1709b6>${ssrInterpolate(__props.facilitadoraLabel)}</p></div><h2 class="font-serif italic text-3xl md:text-4xl lg:text-[40px] text-[#27252B] font-normal tracking-tight leading-tight" data-v-2d1709b6>${ssrInterpolate(__props.facilitadoraTitulo)}<br data-v-2d1709b6><span class="text-[#27252B]/40 not-italic font-sans font-light text-xl md:text-2xl block mt-1" data-v-2d1709b6>${ssrInterpolate(__props.facilitadora.nombre)}</span></h2><div class="space-y-6 text-stone-600/90 text-sm md:text-base leading-relaxed md:leading-loose font-light tracking-wide pt-2 mb-4" data-v-2d1709b6><p data-v-2d1709b6>${__props.bio ?? ""}</p><p data-v-2d1709b6>${__props.bio2 ?? ""}</p></div><div class="pt-4 w-full flex justify-start" data-v-2d1709b6>`);
        ...
        _push(`</div></div></div><div class="w-full aspect-square overflow-hidden bg-[#27252B]/5 relative order-1 lg:order-2 border border-[#27252B]/10 rounded-none max-w-[550px] lg:max-w-full justify-self-center lg:w-full" data-v-2d1709b6><img${ssrRenderAttr("src", __props.facilitadora.imagen)}${ssrRenderAttr("alt", __props.facilitadoraImagenAlt || __props.facilitadora.imagenAlt)} class="absolute inset-0 w-full h-full object-cover object-center grayscale-[15%] hover:grayscale-0 transition-all duration-[1200ms] ease-out scale-100 hover:scale-102" loading="lazy" data-v-2d1709b6></div></section>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const WorkshopIntro = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$4, [["__scopeId", "data-v-2d1709b6"]]), { __name: "TalleresWorkshopIntro" });
...
//# sourceMappingURL=_id_-BOX-plVF.mjs.map
