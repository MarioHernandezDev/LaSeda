...
import { defineComponent, computed, mergeProps, withCtx, createTextVNode, unref, createVNode, toDisplayString, openBlock, createBlock, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderClass } from 'vue/server-renderer';
import { _ as __nuxt_component_1$1 } from './NuxtImg-BPQsK4wb.mjs';
import { _ as __nuxt_component_7$1 } from './TherapyFAQ-BHZ_y8O_.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (formacionesSugeridas.value.length > 0) {
        _push(`<section${ssrRenderAttrs(mergeProps({ class: "py-24 bg-[#FDFBF9] border-t border-[#27252B]/5 relative overflow-hidden" }, _attrs))}><div class="page-container relative z-10"><div class="flex items-end justify-between mb-12 md:mb-16"><div><div class="flex items-center gap-3 mb-3"><span class="w-1.5 h-1.5 rounded-full bg-[#71B1A5]" aria-hidden="true"></span><p class="text-[#71B1A5] text-[10px] tracking-[0.35em] uppercase font-bold"> Otros Programas </p></div><h2 class="font-serif italic text-2xl md:text-3xl lg:text-4xl text-[#27252B]"> Especializaciones relacionadas </h2></div>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/formaciones",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_TherapyFAQ = __nuxt_component_7$1;
...
//# sourceMappingURL=_id_-CWJoXwKP.mjs.map
