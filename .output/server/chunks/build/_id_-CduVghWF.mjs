...
import { defineComponent, computed, mergeProps, withCtx, createTextVNode, createVNode, toDisplayString, openBlock, createBlock, ref, useSSRContext } from 'vue';
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full text-[#27252B] font-sans pt-12 md:pt-16 pb-24 lg:pb-32 space-y-24 lg:space-y-36 bg-[#FDFBF9]" }, _attrs))} data-v-23bbb30c><section class="grid grid-cols-1 lg:grid-cols-2 items-stretch min-h-[50vh] lg:min-h-[650px] gap-8 lg:gap-0 border-b border-[#27252B]/5 pb-24 lg:pb-0" data-v-23bbb30c><div class="w-full min-h-[350px] sm:min-h-[450px] lg:min-h-full h-full overflow-hidden bg-[#27252B]/5 relative border-b lg:border-b-0 lg:border-r border-[#27252B]/10 rounded-none" data-v-23bbb30c><img${ssrRenderAttr("src", __props.imagen)}${ssrRenderAttr("alt", __props.imagenAlt)} class="absolute inset-0 w-full h-full object-cover grayscale-[10%] hover:scale-102 transition-all duration-[1200ms] ease-out" loading="lazy" data-v-23bbb30c></div><div class="px-6 sm:px-16 md:px-24 py-8 lg:py-24 w-full flex flex-col justify-center items-start lg:max-w-[90%] xl:max-w-[85%] justify-self-start" data-v-23bbb30c><div class="space-y-6 w-full" data-v-23bbb30c><div class="flex items-center gap-3" data-v-23bbb30c><span class="w-6 h-px bg-[#71B1A5]" aria-hidden="true" data-v-23bbb30c></span><p class="text-xs font-bold tracking-[0.3em] uppercase text-[#71B1A5]" data-v-23bbb30c>${ssrInterpolate(__props.introduccionLabel)}</p></div><h2 class="font-serif italic text-3xl md:text-4xl lg:text-[40px] text-[#27252B] font-normal leading-tight tracking-tight" data-v-23bbb30c>${ssrInterpolate(__props.introduccionTitulo)}<br data-v-23bbb30c><span class="text-[#27252B]/50 not-italic font-sans font-light text-2xl md:text-3xl block mt-1" data-v-23bbb30c>${ssrInterpolate(__props.introduccionTituloSecundario)}</span></h2><div class="space-y-6 text-stone-600/90 text-sm md:text-base leading-relaxed md:leading-loose font-light tracking-wide pt-2" data-v-23bbb30c><p data-v-23bbb30c>${ssrInterpolate(__props.descripcion)}</p><p data-v-23bbb30c>${ssrInterpolate(__props.descripcion2)}</p>`);
      if (__props.descripcion3) {
        _push(`<p data-v-23bbb30c>${ssrInterpolate(__props.descripcion3)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></div></section>`);
      if (__props.facilitadora) {
        _push(`<section class="grid grid-cols-1 lg:grid-cols-2 items-center min-h-[50vh] lg:min-h-[650px] gap-8 lg:gap-0" data-v-23bbb30c><div class="px-6 sm:px-16 md:px-24 py-8 lg:py-24 w-full flex flex-col justify-center items-end lg:max-w-[90%] xl:max-w-[85%] justify-self-end order-2 lg:order-1" data-v-23bbb30c><div class="space-y-6 w-full" data-v-23bbb30c><div class="flex items-center gap-3" data-v-23bbb30c><span class="w-6 h-px bg-[#71B1A5]" aria-hidden="true" data-v-23bbb30c></span><p class="text-xs font-bold tracking-[0.3em] uppercase text-[#71B1A5]" data-v-23bbb30c>${ssrInterpolate(__props.facilitadoraLabel)}</p></div><h2 class="font-serif italic text-3xl md:text-4xl lg:text-[40px] text-[#27252B] font-normal tracking-tight leading-tight" data-v-23bbb30c>${ssrInterpolate(__props.facilitadoraTitulo)}<br data-v-23bbb30c><span class="text-[#27252B]/40 not-italic font-sans font-light text-xl md:text-2xl block mt-1" data-v-23bbb30c>${ssrInterpolate(__props.facilitadora.nombre)}</span></h2><div class="space-y-6 text-stone-600/90 text-sm md:text-base leading-relaxed md:leading-loose font-light tracking-wide pt-2 mb-4" data-v-23bbb30c><p data-v-23bbb30c>${__props.bio ?? ""}</p><p data-v-23bbb30c>${__props.bio2 ?? ""}</p></div><div class="pt-4 w-full flex justify-start" data-v-23bbb30c>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span data-v-23bbb30c${_scopeId}>${ssrInterpolate(__props.facilitadoraBoton)}</span><div class="relative w-4 h-3 overflow-hidden flex items-center justify-center" data-v-23bbb30c${_scopeId}><svg class="w-3.5 h-3.5 transition-transform duration-500 ease-out transform group-hover:translate-x-5 absolute" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-23bbb30c${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M14 5l7 7m0 0l-7 7m7-7H3" data-v-23bbb30c${_scopeId}></path></svg><svg class="w-3.5 h-3.5 transition-transform duration-500 ease-out transform -translate-x-5 group-hover:translate-x-0 absolute text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-23bbb30c${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M14 5l7 7m0 0l-7 7m7-7H3" data-v-23bbb30c${_scopeId}></path></svg></div>`);
            } else {
              return [
        ...
        _push(`</div></div></div><div class="w-full aspect-square overflow-hidden bg-[#27252B]/5 relative order-1 lg:order-2 border border-[#27252B]/10 rounded-none max-w-[550px] lg:max-w-full justify-self-center lg:w-full" data-v-23bbb30c><img${ssrRenderAttr("src", __props.facilitadora.imagen)}${ssrRenderAttr("alt", __props.facilitadoraImagenAlt || __props.facilitadora.imagenAlt)} class="absolute inset-0 w-full h-full object-cover object-center grayscale-[15%] hover:grayscale-0 transition-all duration-[1200ms] ease-out scale-100 hover:scale-102" loading="lazy" data-v-23bbb30c></div></section>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const WorkshopIntro = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$4, [["__scopeId", "data-v-23bbb30c"]]), { __name: "TalleresWorkshopIntro" });
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "bg-[#27252B] py-24 md:py-36 overflow-hidden relative" }, _attrs))} data-v-647a24f3><div class="absolute top-1/4 right-[-10%] w-[600px] h-[600px] rounded-full bg-[#71B1A5]/[0.02] blur-[120px] pointer-events-none" aria-hidden="true" data-v-647a24f3></div><div class="page-container relative z-10" data-v-647a24f3><div class="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-20 md:mb-28" data-v-647a24f3><div class="max-w-2xl" data-v-647a24f3><div class="flex items-center gap-3 mb-5" data-v-647a24f3><span class="w-4 h-px bg-[#71B1A5]/60" aria-hidden="true" data-v-647a24f3></span><p class="text-[#71B1A5] text-[10px] tracking-[0.35em] uppercase font-bold" data-v-647a24f3>${ssrInterpolate(__props.label)}</p></div><h2 class="font-serif italic text-[#FDFBF9] text-4xl md:text-5xl leading-[1.15] tracking-tight" data-v-647a24f3>${ssrInterpolate(__props.titulo)}</h2></div><div class="hidden md:block w-32 h-px bg-[#71B1A5]/25 mb-4 shrink-0" aria-hidden="true" data-v-647a24f3></div></div><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-16 md:gap-y-20" data-v-647a24f3><!--[-->`);
      ssrRenderList(__props.beneficios, (b, i) => {
        _push(`<div class="group/card flex flex-col items-start relative transition-all duration-500 ease-out" data-v-647a24f3><div class="flex items-baseline justify-between w-full mb-4" data-v-647a24f3><span class="font-serif italic text-[#71B1A5]/30 group-hover/card:text-[#71B1A5]/80 text-5xl font-medium transition-all duration-500 ease-out transform group-hover/card:-translate-y-1 select-none" aria-hidden="true" data-v-647a24f3>${ssrInterpolate(b.numero)}</span><span class="w-0 h-[1px] bg-[#71B1A5]/40 transition-all duration-700 ease-out group-hover/card:w-12" aria-hidden="true" data-v-647a24f3></span></div><div class="w-full pt-4 border-t border-white/[0.07] group-hover/card:border-[#71B1A5]/30 transition-colors duration-500" data-v-647a24f3><h3 class="text-[#FDFBF9] font-medium text-lg tracking-wide mb-3 transition-colors duration-300 group-hover/card:text-white" data-v-647a24f3>${ssrInterpolate(b.titulo)}</h3><p class="text-white/50 text-[14px] leading-[1.75] font-light tracking-wide transition-colors duration-500 group-hover/card:text-white/70" data-v-647a24f3>${ssrInterpolate(b.desc)}</p></div></div>`);
      });
...
const WorkshopBenefits = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["__scopeId", "data-v-647a24f3"]]), { __name: "TalleresWorkshopBenefits" });
...
//# sourceMappingURL=_id_-CduVghWF.mjs.map
