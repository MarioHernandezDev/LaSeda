...
import { defineComponent, computed, mergeProps, withCtx, createVNode, createTextVNode, openBlock, createBlock, useSSRContext } from 'vue';
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "page-hero-root relative overflow-hidden h-auto md:h-[calc(100vh-20rem)] pt-24 md:pt-24 w-full bg-[#F5F2EE]" }, _attrs))} data-v-2b54477c><div class="page-hero-panel relative z-20 h-auto md:h-full flex flex-col justify-center max-md:justify-start" data-v-2b54477c><div class="absolute inset-0 opacity-[0.015] pointer-events-none z-0 hidden md:block" style="${ssrRenderStyle({ "background-image": "radial-gradient(circle, #27252B 1px, transparent 1px)", "background-size": "32px 32px" })}" aria-hidden="true" data-v-2b54477c></div><div class="w-full max-w-7xl mx-auto relative z-10 px-6 sm:px-12 md:px-16 lg:px-24 max-md:pb-12" data-v-2b54477c><div class="max-md:bg-[#F5F2EE] max-md:p-8 max-md:rounded-sm max-w-2xl py-10 md:py-24" data-v-2b54477c><div class="hidden md:flex items-center gap-3 mb-6 md:mb-8" data-v-2b54477c><span class="w-6 h-px bg-[#71B1A5]/60" aria-hidden="true" data-v-2b54477c></span><p class="text-[#71B1A5] text-[10px] md:text-[11px] tracking-[0.35em] uppercase font-semibold leading-none" data-v-2b54477c>${ssrInterpolate(__props.perfil.especialidadLabel)} · LA SEDA </p></div><div class="mb-6 md:mb-8" data-v-2b54477c><h1 class="font-serif italic font-normal leading-[1.1] tracking-tight text-[#27252B]" style="${ssrRenderStyle({ "font-size": "clamp(2.4rem, 4.5vw, 4.2rem)" })}" data-v-2b54477c>${ssrInterpolate(__props.perfil.nombre)}</h1>`);
      if (__props.perfil.tituloOficial) {
        _push(`<span class="not-italic font-sans text-[#27252B]/60 block mt-3 text-xs md:text-sm font-light tracking-wide max-w-xl leading-relaxed" data-v-2b54477c>${ssrInterpolate(__props.perfil.tituloOficial)}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><blockquote class="hidden md:block relative pl-5 border-l border-[#71B1A5]/40 mb-8 md:mb-10 max-w-lg" data-v-2b54477c><p class="text-[#27252B]/80 font-serif italic leading-relaxed" style="${ssrRenderStyle({ "font-size": "clamp(0.95rem, 1.2vw, 1.15rem)" })}" data-v-2b54477c> “${ssrInterpolate(__props.perfil.cita)}” </p></blockquote><div class="flex flex-col sm:flex-row sm:items-center gap-5 pt-2" data-v-2b54477c>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-2b54477c${_scopeId}>Agendar Consulta</span><div class="relative w-4 h-3 overflow-hidden flex items-center justify-center text-white pointer-events-none" data-v-2b54477c${_scopeId}><svg class="w-3.5 h-3.5 transition-transform duration-500 ease-out transform group-hover:translate-x-5 absolute" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-2b54477c${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M14 5l7 7m0 0l-7 7m7-7H3" data-v-2b54477c${_scopeId}></path></svg><svg class="w-3.5 h-3.5 transition-transform duration-500 ease-out transform -translate-x-5 group-hover:translate-x-0 absolute text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-2b54477c${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M14 5l7 7m0 0l-7 7m7-7H3" data-v-2b54477c${_scopeId}></path></svg></div>`);
          } else {
            return [
              createVNode("span", null, "Agendar Consulta"),
      ...
      _push(`<div class="inline-flex items-center justify-center text-[10px] tracking-[0.2em] uppercase font-medium text-[#27252B]/40 px-3 py-2 bg-[#27252B]/5 rounded-xs w-full sm:w-auto select-none whitespace-nowrap" data-v-2b54477c>${ssrInterpolate(__props.perfil.rol)}</div></div></div></div></div><div class="page-hero-panel-right max-md:relative max-md:inset-auto max-md:w-full max-md:h-[min(82vw,28rem)] z-10 overflow-hidden" data-v-2b54477c>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: __props.perfil.imagen,
        alt: __props.perfil.imagenAlt,
      ...
      _push(`<div class="absolute inset-0 bg-gradient-to-t from-[#27252B]/40 via-transparent to-transparent md:hidden" aria-hidden="true" data-v-2b54477c></div></div></header>`);
    };
  }
});
...
_sfc_main$4.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/conocenos/ConocenosMiniHero.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$4, [["__scopeId", "data-v-2b54477c"]]), { __name: "ConocenosMiniHero" });
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  __name: "ConocenosBiography",
  __ssrInlineRender: true,
  props: {
    perfil: {}
  },
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full text-[#27252B] font-sans my-16 md:my-28 space-y-0 bg-[#FDFBF9]" }, _attrs))} data-v-90b75bfe><section class="grid grid-cols-1 lg:grid-cols-12 items-stretch min-h-[50vh] lg:min-h-[680px] gap-0" data-v-90b75bfe>`);
      if (fotoUno.value) {
        _push(`<div class="lg:col-span-5 w-full min-h-[400px] lg:min-h-full h-full overflow-hidden bg-stone-100 relative" data-v-90b75bfe><img${ssrRenderAttr("src", fotoUno.value.src)}${ssrRenderAttr("alt", fotoUno.value.alt)} class="absolute inset-0 w-full h-full object-cover grayscale-[10%] hover:grayscale-0 transition-all duration-[1200ms] ease-out scale-100 hover:scale-102" loading="lazy" data-v-90b75bfe></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="lg:col-span-7 px-8 sm:px-16 md:px-24 lg:px-28 py-16 lg:py-24 w-full flex flex-col justify-center items-start" data-v-90b75bfe><div class="space-y-8 max-w-2xl w-full" data-v-90b75bfe><div class="flex items-center gap-3" data-v-90b75bfe><span class="w-6 h-px bg-[#71B1A5]" aria-hidden="true" data-v-90b75bfe></span><p class="text-xs font-bold tracking-[0.3em] uppercase text-[#71B1A5]" data-v-90b75bfe> Filosofía y Enfoque </p></div><h3 class="font-serif italic text-3xl md:text-4xl lg:text-5xl text-[#27252B] font-normal leading-[1.15] tracking-tight" data-v-90b75bfe> Trayectoria y Enfoque Humano </h3><div class="space-y-6 text-stone-600/90 text-base md:text-[16.5px] leading-[1.85] font-light tracking-wide pt-2" data-v-90b75bfe>`);
      if (__props.perfil.biografiaExtendida.length > 0) {
        _push(`<p class="font-serif italic text-lg md:text-xl text-[#27252B]/90 border-l-2 border-[#71B1A5] pl-6 py-1 mb-8 leading-relaxed" data-v-90b75bfe>${__props.perfil.biografiaExtendida[0] ?? ""}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--[-->`);
      ssrRenderList(__props.perfil.biografiaExtendida.slice(1), (parrafo, i) => {
        _push(`<p data-v-90b75bfe>${parrafo ?? ""}</p>`);
      });
      _push(`<!--]--></div></div></div></section><section class="grid grid-cols-1 lg:grid-cols-12 items-stretch min-h-[50vh] lg:min-h-[680px] gap-0" data-v-90b75bfe><div class="lg:col-span-7 px-8 sm:px-16 md:px-24 lg:px-28 py-16 lg:py-24 w-full flex flex-col justify-center items-start order-2 lg:order-1" data-v-90b75bfe><div class="space-y-8 max-w-2xl w-full" data-v-90b75bfe><div class="flex items-center gap-3" data-v-90b75bfe><span class="w-6 h-px bg-[#71B1A5]" aria-hidden="true" data-v-90b75bfe></span><p class="text-xs font-bold tracking-[0.3em] uppercase text-[#71B1A5]" data-v-90b75bfe> Evolución Profesional </p></div><h3 class="font-serif italic text-3xl md:text-4xl lg:text-5xl text-[#27252B] font-normal tracking-tight leading-[1.15]" data-v-90b75bfe> El tejido de una identidad </h3><div class="space-y-8 pt-4 w-full" data-v-90b75bfe><!--[-->`);
      ssrRenderList(__props.perfil.trayectoria, (parrafo, i) => {
        _push(`<div class="flex gap-5 group items-start" data-v-90b75bfe><div class="font-serif italic text-lg text-[#71B1A5] bg-[#71B1A5]/5 w-10 h-10 rounded-full flex items-center justify-center shrink-0 transition-all duration-300 group-hover:bg-[#71B1A5] group-hover:text-white" data-v-90b75bfe> 0${ssrInterpolate(i + 1)}</div><div class="text-stone-600/90 text-sm md:text-base leading-[1.75] font-light tracking-wide pt-1.5 transition-colors duration-300 group-hover:text-[#27252B]" data-v-90b75bfe>${parrafo ?? ""}</div></div>`);
      });
      _push(`<!--]--></div></div></div>`);
      if (fotoDos.value) {
        _push(`<div class="lg:col-span-5 w-full min-h-[400px] lg:min-h-full h-full overflow-hidden bg-stone-100 relative order-1 lg:order-2" data-v-90b75bfe><img${ssrRenderAttr("src", fotoDos.value.src)}${ssrRenderAttr("alt", fotoDos.value.alt)} class="absolute inset-0 w-full h-full object-cover object-top grayscale-[10%] hover:grayscale-0 transition-all duration-[1200ms] ease-out scale-100 hover:scale-102" loading="lazy" data-v-90b75bfe></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</section></div>`);
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/conocenos/ConocenosBiography.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["__scopeId", "data-v-90b75bfe"]]), { __name: "ConocenosBiography" });
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  __name: "ConocenosSpecialties",
  __ssrInlineRender: true,
  props: {
    perfil: {}
  },
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-6" }, _attrs))}><p class="text-xs font-semibold tracking-[0.2em] uppercase text-[#27252B]/40"> Áreas de Especialización </p><ul class="grid sm:grid-cols-2 gap-6 lg:gap-8 list-none p-0 m-0" aria-label="Áreas de especialización"><!--[-->`);
      ssrRenderList(__props.perfil.areasEspecializacion, (area, i) => {
        _push(`<li class="bg-white border border-[#27252B]/5 p-6 lg:p-8 space-y-2 border-l-2 border-l-[#71B1A5] shadow-sm shadow-[#27252B]/1 transition-transform duration-300 hover:-translate-y-0.5"><p class="font-serif italic text-lg text-[#27252B]">${ssrInterpolate(area.titulo)}</p><p class="text-sm leading-relaxed font-light text-[#27252B]/65">${ssrInterpolate(area.descripcion)}</p></li>`);
      });
      _push(`<!--]--></ul></div>`);
    };
  }
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/conocenos/ConocenosSpecialties.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const __nuxt_component_2 = Object.assign(_sfc_main$2, { __name: "ConocenosSpecialties" });
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  __name: "ConocenosAcademic",
  __ssrInlineRender: true,
  props: {
    perfil: {}
  },
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-8" }, _attrs))}><div class="flex items-center gap-3"><span class="w-1.5 h-1.5 rounded-full bg-[#71B1A5]" aria-hidden="true"></span><p class="text-[10px] font-bold tracking-[0.25em] uppercase text-[#27252B]/40 font-sans"> Formación Académica Destacada </p></div><ol class="space-y-0 list-none p-0 m-0 border-t border-[#27252B]/10"><!--[-->`);
      ssrRenderList(__props.perfil.formacion, (item, i) => {
        _push(`<li class="flex items-start gap-6 py-6 border-b border-[#27252B]/5 group/item transition-all duration-300 hover:pl-2"><span class="font-serif italic text-[#27252B]/20 group-hover/item:text-[#71B1A5] text-2xl md:text-3xl leading-none select-none shrink-0 w-10 transition-colors duration-400 mt-0.5" aria-hidden="true">${ssrInterpolate(String(i + 1).padStart(2, "0"))}</span><div class="flex-1 space-y-1"><p class="font-medium text-[#27252B]/85 group-hover/item:text-[#27252B] text-base md:text-[17px] leading-snug transition-colors duration-300">${ssrInterpolate(item.titulo)}</p><div class="flex items-center gap-2"><span class="w-1 h-px bg-[#71B1A5]/40 opacity-0 group-hover/item:opacity-100 transition-opacity duration-300"></span><p class="text-xs md:text-sm text-[#27252B]/50 font-light tracking-wide font-sans group-hover/item:text-[#27252B]/70 transition-colors duration-300">${ssrInterpolate(item.institucion)}</p></div></div></li>`);
      });
      _push(`<!--]--></ol></div>`);
    };
  }
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/conocenos/ConocenosAcademic.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_3 = Object.assign(_sfc_main$1, { __name: "ConocenosAcademic" });
  ...
  setup(__props) {
    const perfiles = {
      "ana-jimenez": {
        ...
        rol: "Co-dirección",
        esReal: false,
        // Marcada como pendiente (Próximamente)
    ...
    const perfil = computed(() => perfiles[id.value] ?? null);
    useSeoMeta({
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ConocenosMiniHero = __nuxt_component_0;
      const _component_ConocenosBiography = __nuxt_component_1;
      const _component_ConocenosSpecialties = __nuxt_component_2;
      const _component_ConocenosAcademic = __nuxt_component_3;
      const _component_NuxtLink = __nuxt_component_0$1;
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "bg-[#FDFBF9] antialiased min-h-screen relative w-full isolate" }, _attrs))} data-v-4f359add>`);
      if (perfil.value) {
        _push(`<div data-v-4f359add>`);
        if (perfil.value.esReal) {
          _push(`<div data-v-4f359add>`);
          _push(ssrRenderComponent(_component_ConocenosMiniHero, { perfil: perfil.value }, null, _parent));
          _push(`<div class="w-full" data-v-4f359add>`);
          _push(ssrRenderComponent(_component_ConocenosBiography, { perfil: perfil.value }, null, _parent));
          _push(`</div><div class="page-container pb-16 md:pb-24 max-w-5xl mx-auto space-y-24 lg:space-y-36 px-4 sm:px-6 lg:px-8" data-v-4f359add>`);
          _push(ssrRenderComponent(_component_ConocenosSpecialties, { perfil: perfil.value }, null, _parent));
          _push(ssrRenderComponent(_component_ConocenosAcademic, { perfil: perfil.value }, null, _parent));
          _push(`<div class="pt-16 border-t border-[#27252B]/10 space-y-12" data-v-4f359add><div class="flex justify-center pt-6" data-v-4f359add>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: "/conocenos",
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<span class="w-12 h-px bg-[#27252B]/30 group-hover/btn:w-20 group-hover/btn:bg-[#71B1A5] transition-all duration-300" aria-hidden="true" data-v-4f359add${_scopeId}></span><span class="text-xs tracking-[0.2em] uppercase font-bold text-[#27252B]/50 group-hover/btn:text-[#71B1A5] transition-colors duration-300" data-v-4f359add${_scopeId}> Ver todo el equipo </span><span class="w-12 h-px bg-[#27252B]/30 group-hover/btn:w-20 group-hover/btn:bg-[#71B1A5] transition-all duration-300" aria-hidden="true" data-v-4f359add${_scopeId}></span>`);
              } else {
                return [
                  createVNode("span", {
                  ...
                  createVNode("span", { class: "text-xs tracking-[0.2em] uppercase font-bold text-[#27252B]/50 group-hover/btn:text-[#71B1A5] transition-colors duration-300" }, " Ver todo el equipo "),
                  createVNode("span", {
                    class: "w-12 h-px bg-[#27252B]/30 group-hover/btn:w-20 group-hover/btn:bg-[#71B1A5] transition-all duration-300",
                    "aria-hidden": "true"
                  })
          ...
          _push(`<div class="min-h-[80vh] w-full flex flex-col justify-center items-center px-6 py-24 text-center" data-v-4f359add><div class="max-w-md space-y-6" data-v-4f359add><div class="flex justify-center items-center gap-2 mb-2" data-v-4f359add><span class="w-8 h-px bg-[#71B1A5]" aria-hidden="true" data-v-4f359add></span><p class="text-[10px] font-bold tracking-[0.3em] uppercase text-[#71B1A5]" data-v-4f359add>Espacio en preparación</p><span class="w-8 h-px bg-[#71B1A5]" aria-hidden="true" data-v-4f359add></span></div><h1 class="font-serif italic text-4xl text-[#27252B] font-light tracking-tight" data-v-4f359add>${ssrInterpolate(perfil.value.nombre)}</h1><p class="text-stone-500 font-light text-sm leading-relaxed max-w-sm mx-auto" data-v-4f359add> Estamos completando el espacio profesional y la trayectoria clínica de ${ssrInterpolate(perfil.value.nombreCorto || "nuestra especialista")}. Muy pronto estará disponible. </p><div class="pt-6" data-v-4f359add>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: "/conocenos",
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(` ← Volver al equipo `);
              } else {
                return [
                  createTextVNode(" ← Volver al equipo ")
                ];
              }
            }),
            _: 1
        ...
        _push(`<div class="min-h-[80vh] w-full flex flex-col justify-center items-center px-6 py-24 text-center" data-v-4f359add><div class="max-w-md space-y-4" data-v-4f359add><h2 class="font-serif italic text-3xl text-[#27252B]" data-v-4f359add>Perfil no encontrado</h2><p class="text-stone-500 text-sm font-light" data-v-4f359add>El especialista que busca no forma parte del centro actualmente.</p><div class="pt-4" data-v-4f359add>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/conocenos",
          class: "text-xs uppercase font-bold tracking-wider text-[#71B1A5] underline"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(` Volver al listado general `);
            } else {
              return [
                createTextVNode(" Volver al listado general ")
              ];
            }
          }),
          _: 1
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/conocenos/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4f359add"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-CrCMLpVL.mjs.map
