...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "page-hero-root relative overflow-hidden h-[100dvh] md:h-[calc(100vh-20rem)] md:pt-24 w-full bg-[#F5F2EE]" }, _attrs))} data-v-ac1bd728><div class="page-hero-panel relative z-20 h-full flex flex-col justify-center max-md:justify-end" data-v-ac1bd728><div class="absolute inset-0 opacity-[0.015] pointer-events-none z-0 hidden md:block" style="${ssrRenderStyle({ "background-image": "radial-gradient(circle, #27252B 1px, transparent 1px)", "background-size": "32px 32px" })}" aria-hidden="true" data-v-ac1bd728></div><div class="w-full max-w-7xl mx-auto relative z-10 px-6 sm:px-12 md:px-16 lg:px-24 max-md:pb-12" data-v-ac1bd728><div class="max-md:bg-[#F5F2EE]/85 max-md:backdrop-blur-md max-md:p-8 max-md:rounded-sm max-md:border max-md:border-white/20 max-w-2xl py-16 md:py-24" data-v-ac1bd728><div class="hidden md:flex items-center gap-3 mb-6 md:mb-8" data-v-ac1bd728><span class="w-6 h-px bg-[#71B1A5]/60" aria-hidden="true" data-v-ac1bd728></span><p class="text-[#71B1A5] text-[10px] md:text-[11px] tracking-[0.35em] uppercase font-semibold leading-none" data-v-ac1bd728>${ssrInterpolate(__props.perfil.especialidadLabel)} · LA SEDA </p></div><div class="mb-6 md:mb-8" data-v-ac1bd728><h1 class="font-serif italic font-normal leading-[1.1] tracking-tight text-[#27252B]" style="${ssrRenderStyle({ "font-size": "clamp(2.4rem, 4.5vw, 4.2rem)" })}" data-v-ac1bd728>${ssrInterpolate(__props.perfil.nombre)}</h1>`);
      if (__props.perfil.tituloOficial) {
        _push(`<span class="not-italic font-sans text-[#27252B]/60 block mt-3 text-xs md:text-sm font-light tracking-wide max-w-xl leading-relaxed" data-v-ac1bd728>${ssrInterpolate(__props.perfil.tituloOficial)}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><blockquote class="hidden md:block relative pl-5 border-l border-[#71B1A5]/40 mb-8 md:mb-10 max-w-lg" data-v-ac1bd728><p class="text-[#27252B]/80 font-serif italic leading-relaxed" style="${ssrRenderStyle({ "font-size": "clamp(0.95rem, 1.2vw, 1.15rem)" })}" data-v-ac1bd728> “${ssrInterpolate(__props.perfil.cita)}” </p></blockquote><div class="flex flex-col sm:flex-row sm:items-center gap-5 pt-2" data-v-ac1bd728>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-ac1bd728${_scopeId}>Agendar Consulta</span><div class="relative w-4 h-3 overflow-hidden flex items-center justify-center text-white pointer-events-none" data-v-ac1bd728${_scopeId}><svg class="w-3.5 h-3.5 transition-transform duration-500 ease-out transform group-hover:translate-x-5 absolute" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ac1bd728${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M14 5l7 7m0 0l-7 7m7-7H3" data-v-ac1bd728${_scopeId}></path></svg><svg class="w-3.5 h-3.5 transition-transform duration-500 ease-out transform -translate-x-5 group-hover:translate-x-0 absolute text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ac1bd728${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M14 5l7 7m0 0l-7 7m7-7H3" data-v-ac1bd728${_scopeId}></path></svg></div>`);
          } else {
            return [
      ...
      _push(`<div class="inline-flex items-center justify-center text-[10px] tracking-[0.2em] uppercase font-medium text-[#27252B]/40 px-3 py-2 bg-[#27252B]/5 rounded-xs w-full sm:w-auto select-none whitespace-nowrap" data-v-ac1bd728>${ssrInterpolate(__props.perfil.rol)}</div></div></div></div></div><div class="page-hero-panel-right max-md:absolute max-md:inset-0 max-md:w-full max-md:h-full z-10 overflow-hidden" data-v-ac1bd728>`);
      ...
      _push(`<div class="absolute inset-0 bg-gradient-to-t from-[#27252B]/40 via-transparent to-transparent md:hidden" aria-hidden="true" data-v-ac1bd728></div></div></header>`);
    };
  }
});
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$4, [["__scopeId", "data-v-ac1bd728"]]), { __name: "ConocenosMiniHero" });
...
//# sourceMappingURL=_id_-Rw7o1crI.mjs.map
