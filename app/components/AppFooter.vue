<template>
  <footer class="bg-[#1e1c21] text-white/40" aria-label="Pie de página">
      ...
      <div class="grid md:grid-cols-12 gap-12 md:gap-10">
        ...
        <div class="md:col-span-4">
          ...
          <div class="flex items-center gap-3 mt-8">
            <a href="https://www.instagram.com/centrolaseda/" target="_blank" rel="noopener noreferrer" class="text-white/40 hover:text-[#71B1A5] transition-colors duration-300" aria-label="Instagram de Centro La Seda">
            ...
            <a href="https://www.facebook.com/CentroLaSeda/?locale=es_ES" target="_blank" rel="noopener noreferrer" class="text-white/40 hover:text-[#71B1A5] transition-colors duration-300" aria-label="Facebook de Centro La Seda">
              <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M9 8H7v3h2v9h4v-9h3l.5-3H13V6c0-.5.5-1 1-1h2V1H13a5 5 0 00-5 5v2z"/></svg>
            </a>
          </div>
        </div>
        ...
        <div class="md:col-span-3 md:col-start-6">
          ...
          <ul class="space-y-3" role="list">
            <li v-for="link in footerNavLinks" :key="link.to">
              <NuxtLink :to="link.to" class="group inline-flex items-center gap-2 text-sm font-light hover:text-[#71B1A5] transition-colors duration-300">
          ...
          <address class="not-italic space-y-4">
            <div class="flex items-start gap-3">
              ...
              <p class="text-sm font-light leading-relaxed">
                C. Horno de Haza, 29, Bajo 1<br/><span class="text-white/30 text-xs italic font-sans">(Se accede por el portal)</span><br/>Centro, 18002 Granada
              </p>
            </div>
            <div class="flex items-center gap-3">
              <svg class="w-4 h-4 text-[#71B1A5] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
              <a href="tel:+34679571977" class="text-sm font-light hover:text-[#71B1A5] transition-colors duration-300">679 571 977</a>
            </div>
          </address>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-8 md:px-16 py-6 border-t border-white/5 text-[10px] tracking-widest uppercase">
      <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
        <span class="text-white/25">© {{ currentYear }} Centro La Seda · Granada</span>
        <nav aria-label="Navegación legal" class="flex items-center gap-6">
          <NuxtLink to="/aviso-legal" class="text-white/25 hover:text-[#71B1A5] transition-colors duration-300">Aviso Legal</NuxtLink>
          <NuxtLink to="/privacidad" class="text-white/25 hover:text-[#71B1A5] transition-colors duration-300">Privacidad</NuxtLink>
        </nav>
      </div>
    </div>
  </footer>
