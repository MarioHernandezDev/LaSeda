  ...
  <section class="bg-[#27252B] py-24 md:py-32 relative overflow-hidden">
    ...
    <div class="page-container relative z-10">
      ...
      <div class="grid md:grid-cols-12 gap-8 md:gap-16 items-end mb-20 md:mb-24">
        ...
        <div class="md:col-span-6 lg:col-span-7 border-l border-white/10 pl-6 md:pl-10">
          <p class="text-white/60 text-base md:text-[17px] leading-[1.85] font-light max-w-xl">
            ...
            en la que te escuchamos de forma activa para valorar qué tipo de abordaje clínico y qué profesional de nuestro equipo se adapta mejor a tu reality presente.
          </p>
        </div>
      </div>
      ...
      <div class="mt-20 flex flex-col sm:flex-row items-center justify-center gap-5 border-t border-white/5 pt-12 w-full">
        ...
        >
          <span class="text-[11px] tracking-[0.25em] uppercase font-medium">Pedir orientación gratuita</span>
        ...
        >
          <span class="text-[11px] tracking-[0.25em] uppercase font-medium">Ver otras especialidades</span>
