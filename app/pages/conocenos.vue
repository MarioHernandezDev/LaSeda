<template>
  ...
  <main>
    ...
    >
      <div class="page-container">
        <div class="grid md:grid-cols-2 gap-14 md:gap-20 items-center">
          ...
          <!-- Texto y detalles -->
          <div>
            <p class="section-label mb-4">El espacio</p>
            <h2
              id="espacio-heading"
            ...
            <dl class="space-y-10" aria-label="Datos del espacio terapéutico">
              ...
              <div class="flex gap-6 items-start">
                ...
                <div class="pt-2 border-t border-[#27252B]/10 flex-1">
                  <dt class="text-[#27252B] font-medium text-base md:text-lg mb-2 tracking-wide">Años en Granada</dt>
                  <dd class="text-base md:text-lg leading-[1.85] text-[#27252B]/70">
    ...
    ════════════════════════════════════════════════ -->
    <section
  class="py-20 md:py-28 bg-[#FDFBF9]"
...
>
  <div class="page-container">
    ...
    <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-16 md:mb-24">
      <div>
        <p class="section-label mb-3">Profesionales</p>
        <h2
          id="equipo-heading"
          class="font-serif italic text-3xl md:text-5xl leading-[1.15]"
        >
          Personas que cuidan<br />
          <span class="text-[#27252B]/60">a personas.</span>
        </h2>
      </div>
      <p class="text-[#27252B]/50 max-w-sm text-sm md:text-base leading-relaxed font-light md:text-right md:mb-2">
        Un equipo multidisciplinar especializado en psicología, coaching
        y educación emocional comprometido con tu bienestar.
      </p>
    </div>

    <ul
      class="flex flex-col gap-12 md:gap-16 list-none p-0 m-0"
      role="list"
    ...
    >
      ...
      <li>
        <article
          class="group relative flex flex-col md:flex-row bg-[#FDFBF9] border border-[#27252B]/5 rounded-none overflow-hidden hover:shadow-xl hover:shadow-[#27252B]/4 hover:-translate-y-1 transition-all duration-500 ease-out"
          aria-labelledby="nombre-ana"
        >
          <div class="relative overflow-hidden w-full md:w-72 lg:w-80 shrink-0 aspect-[4/3] md:aspect-auto min-h-[340px]">
            <NuxtImg
              src="/images/ana-jimenez-psicologa-gestalt-terapia-infanto-juvenil-granada.jpg"
              alt="Ana Jiménez, psicóloga colegiada y co-directora del Centro La Seda Granada"
              class="w-full h-full object-cover object-top grayscale-[20%] group-hover:grayscale-0 group-hover:scale-102 transition-all duration-700 ease-out"
              width="320"
              height="420"
              format="webp"
              loading="lazy"
            />
            <div class="absolute inset-0 bg-gradient-to-t from-[#27252B]/20 via-transparent to-transparent md:bg-gradient-to-r md:from-transparent md:to-[#27252B]/5" aria-hidden="true" />
            <div class="absolute top-4 left-4 z-10 text-[11px] font-medium tracking-wider uppercase bg-[#71B1A5] text-white px-3 py-1.5 rounded-none shadow-sm" aria-label="Rol: Co-dirección">
              Co-dirección
            </div>
          </div>

          <div class="p-8 md:p-10 lg:p-12 flex flex-col flex-1 justify-between gap-6">
            <div class="space-y-4">
              <div>
                <h3 id="nombre-ana" class="font-serif italic text-2xl md:text-3xl text-[#27252B] leading-tight mb-1">
                  Ana Jiménez
                </h3>
                <p class="text-xs md:text-sm font-medium tracking-wider text-[#71B1A5] uppercase">Psicóloga · Co-directora de La Seda</p>
              </div>

              <blockquote class="border-l-2 border-[#71B1A5]/40 pl-4 py-0.5">
                <p class="font-serif italic text-[#27252B]/80 text-base md:text-lg leading-relaxed">
                  "Acompañar desde la presencia es permitir que cada persona descubra su propio ritmo para florecer."
                </p>
              </blockquote>

              <p class="text-[#27252B]/70 text-sm leading-[1.85] font-light max-w-3xl">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-4 border-t border-[#27252B]/8">
              <div class="flex items-center gap-2">
                ...
                <span class="text-xs text-[#27252B]/50 font-light tracking-wider">
                  Colegiada <strong class="text-[#27252B]/70 font-medium">Nº AO06843</strong>
                </span>
              </div>
              
              <a
                href="https://anajimenezpsicologa.es/"
                target="_blank"
                rel="noopener noreferrer"
                class="relative inline-flex items-center gap-1 text-sm font-medium text-[#27252B] after:absolute after:bottom-0 after:left-0 after:h-[1px] after:w-full after:origin-bottom-right after:scale-x-0 after:bg-[#71B1A5] after:transition-transform after:duration-300 group-hover:after:origin-bottom-left group-hover:after:scale-x-100 py-0.5"
                aria-label="Ver especialidad de Ana Jiménez en su web personal (abre en nueva pestaña)"
              >
                <span>Ver especialidad</span>
                <svg class="w-3.5 h-3.5 text-[#71B1A5] transform transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
              </a>
            </div>
          </div>
        </article>
      ...
      <li>
        <article
          class="group relative flex flex-col md:flex-row bg-[#FDFBF9] border border-[#27252B]/5 rounded-none overflow-hidden hover:shadow-xl hover:shadow-[#27252B]/4 hover:-translate-y-1 transition-all duration-500 ease-out"
          aria-labelledby="nombre-leonor"
        >
          <div class="relative overflow-hidden w-full md:w-72 lg:w-80 shrink-0 aspect-[4/3] md:aspect-auto min-h-[340px]">
            <NuxtImg
              src="/images/leonor-cabrera-coach-wingwave-constelaciones-familiares-granada.jpg"
              alt="Leonor Cabrera, coach profesional certificada y co-directora de La Seda Granada"
              class="w-full h-full object-cover object-top grayscale-[20%] group-hover:grayscale-0 group-hover:scale-102 transition-all duration-700 ease-out"
              width="320"
              height="420"
              format="webp"
          ...
          <div class="p-8 md:p-10 lg:p-12 flex flex-col flex-1 justify-between gap-6">
            <div class="space-y-4">
              <div>
                <h3 id="nombre-leonor" class="font-serif italic text-2xl md:text-3xl text-[#27252B] leading-tight mb-1">
                  Leonor Cabrera
                </h3>
                <p class="text-xs md:text-sm font-medium tracking-wider text-[#71B1A5] uppercase">Coach · Co-directora de La Seda</p>
              </div>

              <blockquote class="border-l-2 border-[#71B1A5]/40 pl-4 py-0.5">
                <p class="font-serif italic text-[#27252B]/80 text-base md:text-lg leading-relaxed">
                  "Desatar los nudos del pasado es el primer paso para caminar con fuerza y ligereza hacia tu presente."
                </p>
              </blockquote>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-4 border-t border-[#27252B]/8">
              <div class="flex items-center gap-2">
                ...
                <span class="text-xs text-[#27252B]/50 font-light tracking-wider">
                  Asesco <strong class="text-[#27252B]/70 font-medium">Nº 10.457</strong>
                </span>
              </div>
              <a
                href="https://leonorcabrera.com/"
                target="_blank"
                rel="noopener noreferrer"
                class="relative inline-flex items-center gap-1 text-sm font-medium text-[#27252B] after:absolute after:bottom-0 after:left-0 after:h-[1px] after:w-full after:origin-bottom-right after:scale-x-0 after:bg-[#71B1A5] after:transition-transform after:duration-300 group-hover:after:origin-bottom-left group-hover:after:scale-x-100 py-0.5"
                aria-label="Ver especialidad de Leonor Cabrera en su web personal (abre en nueva pestaña)"
              >
                <span>Ver especialidad</span>
                <svg class="w-3.5 h-3.5 text-[#71B1A5] transform transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
              </a>
      ...
      <li>
        <article
          class="group relative flex flex-col md:flex-row bg-[#FDFBF9] border border-[#27252B]/5 rounded-none overflow-hidden hover:shadow-xl hover:shadow-[#27252B]/4 hover:-translate-y-1 transition-all duration-500 ease-out"
          aria-labelledby="nombre-cristina"
        >
          <div class="relative overflow-hidden w-full md:w-72 lg:w-80 shrink-0 aspect-[4/3] md:aspect-auto min-h-[340px]">
            <NuxtImg
              src="/images/cristina-lence-educadora-familiar-gestalt-sistemica-granada.jpg"
              alt="Cristina Lence, educadora social especializada en Gestalt y Sistémica"
              class="w-full h-full object-cover object-top grayscale-[20%] group-hover:grayscale-0 group-hover:scale-102 transition-all duration-700 ease-out"
              width="320"
              height="420"
              format="webp"
            ...
            />
            <div class="absolute inset-0 bg-gradient-to-t from-[#27252B]/20 via-transparent to-transparent md:bg-gradient-to-r md:from-transparent md:to-[#27252B]/5" aria-hidden="true" />
            <div class="absolute top-4 left-4 z-10 text-[11px] font-medium tracking-wider uppercase bg-[#71B1A5] text-white px-3 py-1.5 rounded-none shadow-sm" aria-label="Rol: Educación Familiar">
              Educación Familiar
            </div>
          </div>
          ...
          <div class="p-8 md:p-10 lg:p-12 flex flex-col flex-1 justify-between gap-6">
            <div class="space-y-4">
              <div>
                <h3 id="nombre-cristina" class="font-serif italic text-2xl md:text-3xl text-[#27252B] leading-tight mb-1">
                  Cristina Lence
                </h3>
                <p class="text-xs md:text-sm font-medium tracking-wider text-[#71B1A5] uppercase">Educadora Familiar</p>
              </div>

              <blockquote class="border-l-2 border-[#71B1A5]/40 pl-4 py-0.5">
                <p class="font-serif italic text-[#27252B]/80 text-base md:text-lg leading-relaxed">
                  "Ofrecer un espacio seguro a la infancia y a las familias es sembrar raíces fuertes para el mañana."
                </p>
              </blockquote>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-4 border-t border-[#27252B]/8">
              ...
              <a
                href="https://aetg.es/users/cristina-lence-dopico"
                target="_blank"
                rel="noopener noreferrer"
                class="relative inline-flex items-center gap-1 text-sm font-medium text-[#27252B] after:absolute after:bottom-0 after:left-0 after:h-[1px] after:w-full after:origin-bottom-right after:scale-x-0 after:bg-[#71B1A5] after:transition-transform after:duration-300 group-hover:after:origin-bottom-left group-hover:after:scale-x-100 py-0.5"
                aria-label="Ver especialidad de Cristina Lence en AETG (abre en nueva pestaña)"
              >
                <span>Ver especialidad</span>
                <svg class="w-3.5 h-3.5 text-[#71B1A5] transform transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
              </a>
      ...
      <li>
        <article
          class="group relative flex flex-col md:flex-row bg-[#FDFBF9] border border-[#27252B]/5 rounded-none overflow-hidden hover:shadow-xl hover:shadow-[#27252B]/4 hover:-translate-y-1 transition-all duration-500 ease-out"
          aria-labelledby="nombre-reyes"
        >
          <div class="relative overflow-hidden w-full md:w-72 lg:w-80 shrink-0 aspect-[4/3] md:aspect-auto min-h-[340px]">
            <NuxtImg
              src="/images/reyes-sanchez-tallon-medica-pediatra-gestalt-terapia-granada.jpg"
              alt="Reyes Sánchez Tallón, médica pediatra colegiada"
              class="w-full h-full object-cover object-top grayscale-[20%] group-hover:grayscale-0 group-hover:scale-102 transition-all duration-700 ease-out"
              width="320"
              height="420"
              format="webp"
            ...
            />
            <div class="absolute inset-0 bg-gradient-to-t from-[#27252B]/20 via-transparent to-transparent md:bg-gradient-to-r md:from-transparent md:to-[#27252B]/5" aria-hidden="true" />
            <div class="absolute top-4 left-4 z-10 text-[11px] font-medium tracking-wider uppercase bg-[#71B1A5] text-white px-3 py-1.5 rounded-none shadow-sm" aria-label="Rol: Medicina">
              Medicina
            </div>
          </div>
          ...
          <div class="p-8 md:p-10 lg:p-12 flex flex-col flex-1 justify-between gap-6">
            <div class="space-y-4">
              <div>
                <h3 id="nombre-reyes" class="font-serif italic text-2xl md:text-3xl text-[#27252B] leading-tight mb-1">
                  Reyes Sánchez Tallón
                </h3>
                <p class="text-xs md:text-sm font-medium tracking-wider text-[#71B1A5] uppercase">Médica Pediatra</p>
              </div>

              <blockquote class="border-l-2 border-[#71B1A5]/40 pl-4 py-0.5">
                <p class="font-serif italic text-[#27252B]/80 text-base md:text-lg leading-relaxed">
                  "Integrar el cuidado del cuerpo y la salud emocional es devolverle la plenitud y el equilibrio al ser."
                </p>
              </blockquote>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-4 border-t border-[#27252B]/8">
              <div class="flex items-center gap-2">
                ...
                <span class="text-xs text-[#27252B]/50 font-light tracking-wider">
                  Colegiada <strong class="text-[#27252B]/70 font-medium">Nº 18-10008273</strong>
                </span>
              </div>
              <a
                href="https://aetg.es/users/reyes-sanchez-tallon"
                target="_blank"
                rel="noopener noreferrer"
                class="relative inline-flex items-center gap-1 text-sm font-medium text-[#27252B] after:absolute after:bottom-0 after:left-0 after:h-[1px] after:w-full after:origin-bottom-right after:scale-x-0 after:bg-[#71B1A5] after:transition-transform after:duration-300 group-hover:after:origin-bottom-left group-hover:after:scale-x-100 py-0.5"
                aria-label="Ver especialidad de Reyes Sánchez Tallón en AETG (abre en nueva pestaña)"
              >
                <span>Ver especialidad</span>
                <svg class="w-3.5 h-3.5 text-[#71B1A5] transform transition-transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
              </a>
    ...
    <p class="mt-16 text-center text-xs text-[#27252B]/35 font-light tracking-wider">
    ...
    <!-- ═══════════════════════════════════════════════
         SECCIÓN 5 · VALORES (bloque oscuro)
    ════════════════════════════════════════════════ -->
    <section
      class="bg-[#27252B] py-20 md:py-28"
    ...
    >
      <div class="page-container">
        ...
        <ol
          class="grid md:grid-cols-3 gap-10 md:gap-16 list-none"
          aria-label="Valores del equipo de La Seda"
        >
          <li class="border-t border-white/10 pt-8">
            <span
              class="font-serif italic text-[#71B1A5]/30 text-5xl leading-none select-none block mb-6"
              aria-hidden="true"
            >01</span>
    ...
    >
      <div class="grid md:grid-cols-12 gap-8 md:gap-16 items-end mb-10">
        <div class="md:col-span-5">
          <p class="section-label mb-4">Contacto</p>
          <h2
            id="cta-heading"
...
useSeoMeta({
  ...
  description:
    'Conoce a los psicólogos colegiados de La Seda en Granada. Especialistas en terapia individual, infanto-juvenil, de pareja, Gestalt y constelaciones familiares. Pide cita hoy.',
  ogTitle: 'El equipo de La Seda · Psicólogos colegiados en Granada',
  ogDescription:
    'Profesionales colegiados, espacio terapéutico cuidado y enfoque multidisciplinar para tu bienestar. Centro de Psicología La Seda, Granada.',
  ogImage: '/images/centro-psicologia-la-seda-granada-hero.jpg',
  ogType: 'website',
  ogUrl: 'https://www.laseda.es/equipo',
  twitterCard: 'summary_large_image',
  twitterTitle: 'Equipo de psicólogos · La Seda · Granada',
  twitterDescription: 'Psicólogos colegiados especializados en terapia Gestalt, sistémica, infanto-juvenil y coaching en Granada. Centro La Seda.',
  robots: 'index, follow',
  canonical: 'https://www.laseda.es/equipo',
})
      ...
      children: JSON.stringify([
        {
          ...
          '@type': 'ItemList',
          name: 'Equipo de psicólogos — La Seda Granada',
          url: 'https://www.laseda.es/equipo',
          numberOfItems: 4,
          itemListElement: [
            {
              '@type': 'ListItem',
              ...
              item: {
                ...
                url: 'https://anajimenezpsicologa.es/',
                worksFor: {
            ...
            },
            {
              ...
              item: {
                ...
                url: 'https://aetg.es/users/cristina-lence-dopico',
                worksFor: {
                  '@type': 'MedicalBusiness',
                  '@id': 'https://www.laseda.es/#business',
                  name: 'La Seda · Psicología y Crecimiento en Granada',
            ...
            },
            {
              ...
              item: {
                ...
                url: 'https://aetg.es/users/reyes-sanchez-tallon',
                worksFor: {
                  '@type': 'MedicalBusiness',
                  '@id': 'https://www.laseda.es/#business',
                  name: 'La Seda · Psicología y Crecimiento en Granada',
