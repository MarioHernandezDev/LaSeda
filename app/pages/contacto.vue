      ...
      <div class="page-container">
        <div class="grid lg:grid-cols-[1fr_1.4fr] gap-14 xl:gap-20 items-start">
          ...
          <address class="not-italic">
            ...
            <div class="space-y-9">
              ...
              <div class="flex items-start gap-5">
                ...
                <div class="border-t border-[#27252B]/10 pt-3 flex-1">
                  <h3 class="contact-item-label">Dirección</h3>
             ...
             <div class="flex items-start gap-5">
                ...
                <div class="border-t border-[#27252B]/10 pt-3 flex-1">
                  <h3 class="contact-item-label">Teléfono</h3>
                  
                  <a 
                    href="tel:+34958000000"
                    class="block text-[#27252B]/70 text-sm font-light hover:text-[#71B1A5] transition-colors duration-300"
                  ...
                  <a 
                    ...
                    class="whatsapp-btn mt-4 inline-flex"
                    aria-label="Contactar con La Seda Granada por WhatsApp"
                  >
                    <svg class="w-4 h-4 mr-2 inline-block align-middle" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div class="flex items-start gap-5">
                ...
                <div class="border-t border-[#27252B]/10 pt-3 flex-1">
                  <h3 class="contact-item-label">Correo electrónico</h3>
              ...
              <div class="flex items-start gap-5">
                ...
                <div class="border-t border-[#27252B]/10 pt-3 flex-1">
                  <h3 class="contact-item-label mb-3">Horario de atención</h3>
                  <dl class="space-y-2">
                    <div class="flex items-center justify-between gap-8">
                      <dt class="text-[#27252B]/60 text-sm font-light">Lunes – Viernes</dt>
                      <dd class="text-[#27252B] text-sm font-medium tabular-nums">
                        <time>09:00</time> – <time>20:00</time>
                      </dd>
                    </div>
                    <div class="flex items-center justify-between gap-8">
                      <dt class="text-[#27252B]/60 text-sm font-light">Sábados</dt>
                      <dd class="text-[#27252B] text-sm font-medium tabular-nums">
                        <time>10:00</time> – <time>14:00</time>
                      </dd>
                    </div>
                    <div class="flex items-center justify-between gap-8">
                      <dt class="text-[#27252B]/60 text-sm font-light">Domingos</dt>
                      <dd class="text-[#27252B]/40 text-sm font-light">Cerrado</dd>
                    </div>
                  </dl>
                  <div
                  ...
                  >
                    <div class="w-1.5 h-1.5 rounded-full bg-[#71B1A5]" aria-hidden="true" />
                    <span class="section-label">Centro abierto ahora</span>
                  </div>
                </div>
              </div>
            ...
            <nav
              class="mt-12 pt-8 border-t border-[#27252B]/10"
              aria-label="Redes sociales de La Seda Granada"
            >
              <p class="text-xs text-[#27252B]/40 tracking-widest uppercase mb-4">Síguenos</p>
              <ul class="flex items-center gap-3" role="list">
                <li>
                  <a 
                    href="https://www.instagram.com/lasedagranada"
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <li>
                  <a 
                    href="https://www.facebook.com/lasedagranada"
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            <div class="bg-white border border-[#27252B]/8 p-8 md:p-10 shadow-sm">
              ...
              >
                ...
                <div class="form-field">
                  ...
                  <div class="relative">
                    <select
                      ...
                      required
                      aria-required="true"
                      class="input-field appearance-none pr-12 cursor-pointer"
                      :class="{
                        '!border-red-400': errors.servicio,
                        'text-[#27252B]/30': !form.servicio
                      }"
                    ...
                    <div
                      ...
                      aria-hidden="true"
                    >
                      <svg class="w-4 h-4 text-[#27252B]/35" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  <div class="flex items-start gap-3">
                    <input
                      ...
                      required
                      aria-required="true"
                      class="mt-0.5 w-4 h-4 border border-[#27252B]/25 bg-[#FDFBF9] text-[#71B1A5] focus:ring-[#71B1A5] focus:ring-offset-0 cursor-pointer flex-shrink-0"
                    ...
                    />
                    <label for="privacidad" class="text-xs text-[#27252B]/50 leading-relaxed font-light cursor-pointer">
                      He leído y acepto la
                      <NuxtLink
                        to="/privacidad"
                        class="text-[#71B1A5] underline underline-offset-2 hover:text-[#5a9a8e] transition-colors"
                      >
                ...
                <button
                  ...
                  class="btn-primary w-full justify-center py-[1.125rem] disabled:opacity-60 disabled:cursor-not-allowed"
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      <p class="text-sm font-medium text-[#27252B] mb-1">¡Mensaje recibido!</p>
                      <p class="text-xs text-[#27252B]/60 font-light leading-relaxed">
